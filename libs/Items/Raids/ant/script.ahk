...
AltCards() {
    ...
    if (FindText(&X, &Y, 954-150000, 458-150000, 954+150000, 458+150000, 0, 0, Cooldown)) {
        foundCards.Push({name: "Cooldown", x: X, y: Y})
    } else if (FindText(&X, &Y, 654-150000, 456-150000, 654+150000, 456+150000, 0, 0, Cooldown1)) {
        foundCards.Push({name: "Cooldown", x: X, y: Y})
    }
    if (FindText(&X, &Y, 641-150000, 457-150000, 641+150000, 457+150000, 0, 0, Range)) {
        foundCards.Push({name: "Range", x: X, y: Y})
    }
    if (FindText(&X, &Y, 642-150000, 455-150000, 642+150000, 455+150000, 0, 0, Slayer)) {
        foundCards.Push({name: "Slayer", x: X, y: Y})
    } else if (FindText(&X, &Y, 1265-150000, 456-150000, 1265+150000, 456+150000, 0, 0, slayer2)) {
        foundCards.Push({name: "Slayer", x: X, y: Y})
    }
    ...
    if (FindText(&X, &Y, 645-150000, 458-150000, 645+150000, 458+150000, 0, 0, Damage)) {
        foundCards.Push({name: "Damage", x: X, y: Y})
    } else if (FindText(&X, &Y, 653-150000, 459-150000, 653+150000, 459+150000, 0, 0, Damage1)) {
        foundCards.Push({name: "Damage", x: X, y: Y})
    }
    if (FindText(&X, &Y, 960-150000, 540-150000, 960+150000, 540+150000, 0, 0, Champion)) {
        foundCards.Push({name: "Champion", x: X, y: Y})
    }
    if (FindText(&X, &Y, 732-150000, 478-150000, 732+150000, 478+150000, 0, 0, Dodge)) {
