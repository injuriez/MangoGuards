...
myGui.Add("Text", "x8 y-8 w347 h81 +0x200", "LEGEND STAGE TUTORIAL")
myGui.SetFont("s15")
...
myGui.Add("Text", "x16 y520 w162 h23 +0x200", "Step 2: Legend Stage Setup")
myGui.SetFont("s6")
myGui.Add("Text", "x16 y544 w162 h23 +0x200", "Press Legend in mangoguards")
myGui.Add("Text", "x16 y568 w191 h23 +0x200", "Setup your settings then press apply")
myGui.Add("Text", "x200 y392 w3 h198 +0x1 +0x10")
myGui.SetFont("s9 Bold")
myGui.Add("Text", "x208 y424 w238 h23 +0x200", "Step 3: Starting Legend Stages")
myGui.SetFont("s6")
myGui.Add("Text", "x208 y448 w144 h23 +0x200", "Load into a legend stage")
...
myGui.Add("Text", "x208 y520 w300 h23 +0x200", "Once the starter cards + the voting ui are on screen press f1")
myGui.OnEvent('Close', (*) => ExitApp())
myGui.Title := "Legend Stage Tutorial"
